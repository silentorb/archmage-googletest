...
set(bin_dir "${CMAKE_CURRENT_LIST_DIR}/bin/${GENERATOR_KEY}/bin")
...
if (MSVC) # Compiled shared.
  add_custom_command(TARGET ${CURRENT_TARGET} POST_BUILD
    COMMAND ${CMAKE_COMMAND} -E copy ${bin_dir}/gtest.dll $<TARGET_FILE_DIR:${CURRENT_TARGET}>
    COMMAND ${CMAKE_COMMAND} -E copy ${bin_dir}/gtest_main.dll $<TARGET_FILE_DIR:${CURRENT_TARGET}>
    )
endif ()